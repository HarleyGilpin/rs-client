...
public class Class152
{
	...
	static final Class224 method1695(boolean bool, int i, CacheArchive cacheArchive, String string) {
		anInt1938++;
		int i_0_ = cacheArchive.method3519(string, (byte) 84);
		if (i == (i_0_ ^ 0xffffffff)) {
			return new Class224(0);
		}
		int[] is = cacheArchive.method3532(i_0_, 0);
		Class224 class224 = new Class224(is.length);
		int i_1_ = 0;
		int i_2_ = 0;
		while (class224.anInt2670 > i_1_) {
			Buffer buffer = new Buffer(cacheArchive.method3524(false, is[i_2_++], i_0_));
