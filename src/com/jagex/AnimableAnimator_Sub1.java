...
public class AnimableAnimator_Sub1 extends AnimableAnimator
{
	...
	static final void method256(boolean bool, int i, Node_Sub9_Sub1 node_sub9_sub1) {
		...
		if (bool) {
			Class320_Sub9.method3717(AnimableAnimator.aClass42_5498, Class78.aCacheArchive_1033, Class148.aCacheArchive_1827, Class218.aCacheArchive_2563, i + 311506859, node_sub9_sub1);
		}
		if (i != 1405) {
			method255((byte) 54);
		}
